...
import 'package:serverpod_auth_core_server/serverpod_auth_core_server.dart'
    as _i4;
import 'package:oisely_server/src/generated/adoption_info.dart' as _i5;
import 'package:oisely_server/src/generated/behavior_analysis_insight.dart'
    as _i6;
import 'package:oisely_server/src/generated/care_plan_generation_result.dart'
    as _i7;
...
class TestEndpoints {
  ...
  late final _AnimalIdentificationEndpoint animalIdentification;

  late final _BehaviorAnalysisEndpoint behaviorAnalysis;

  late final _CarePlanEndpoint carePlan;
...
class _InternalTestEndpoints extends TestEndpoints
  ...
  void initialize(
    ...
    animalIdentification = _AnimalIdentificationEndpoint(
      endpoints,
      serializationManager,
    );
    behaviorAnalysis = _BehaviorAnalysisEndpoint(
      endpoints,
      serializationManager,
    );
    carePlan = _CarePlanEndpoint(
      endpoints,
      serializationManager,
    );
...
class _AnimalIdentificationEndpoint {
  _AnimalIdentificationEndpoint(
    this._endpointDispatch,
    this._serializationManager,
  );
  ...
  _i3.Future<_i5.AdoptionInfo> identifyAnimal(
    _i1.TestSessionBuilder sessionBuilder,
    String imageBase64,
  ) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      var _localUniqueSession =
          (sessionBuilder as _i1.InternalTestSessionBuilder).internalBuild(
            endpoint: 'animalIdentification',
            method: 'identifyAnimal',
          );
      try {
        var _localCallContext = await _endpointDispatch.getMethodCallContext(
          createSessionCallback: (_) => _localUniqueSession,
          endpointPath: 'animalIdentification',
          methodName: 'identifyAnimal',
        ...
        var _localReturnValue =
            await (_localCallContext.method.call(
                ...
                as _i3.Future<_i5.AdoptionInfo>);
        return _localReturnValue;
      } finally {
        await _localUniqueSession.close();
      }
...
class _BehaviorAnalysisEndpoint {
  _BehaviorAnalysisEndpoint(
    this._endpointDispatch,
    this._serializationManager,
  );
  ...
  _i3.Future<_i6.BehaviorAnalysisInsight> analyzeBehavior(
    _i1.TestSessionBuilder sessionBuilder,
    String videoBase64,
  ) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      ...
      try {
        var _localCallContext = await _endpointDispatch.getMethodCallContext(
          createSessionCallback: (_) => _localUniqueSession,
          endpointPath: 'behaviorAnalysis',
          methodName: 'analyzeBehavior',
          parameters: _i1.testObjectToJson({'videoBase64': videoBase64}),
          serializationManager: _serializationManager,
        );
        var _localReturnValue =
            await (_localCallContext.method.call(
                ...
                as _i3.Future<_i6.BehaviorAnalysisInsight>);
        return _localReturnValue;
      } finally {
        await _localUniqueSession.close();
      }
...
class _CarePlanEndpoint {
  ...
  _i3.Future<_i7.CarePlanGenerationResult> generateCarePlan(
    _i1.TestSessionBuilder sessionBuilder, {
      ...
      try {
        ...
        var _localReturnValue =
            await (_localCallContext.method.call(
                ...
                as _i3.Future<_i7.CarePlanGenerationResult>);
        return _localReturnValue;
      } finally {
        await _localUniqueSession.close();
      }
  ...
  _i3.Future<_i7.CarePlanGenerationResult?> getCarePlan(
    _i1.TestSessionBuilder sessionBuilder, {
    ...
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      ...
      try {
        var _localCallContext = await _endpointDispatch.getMethodCallContext(
          ...
          parameters: _i1.testObjectToJson({'carePlanId': carePlanId}),
          serializationManager: _serializationManager,
        );
        var _localReturnValue =
            await (_localCallContext.method.call(
  ...
  _i3.Future<List<_i8.AnimalCarePlan>> listCarePlansForAnimal(
    _i1.TestSessionBuilder sessionBuilder, {
    required int animalIdentificationRecordId,
  }) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      var _localUniqueSession =
          (sessionBuilder as _i1.InternalTestSessionBuilder).internalBuild(
            endpoint: 'carePlan',
            method: 'listCarePlansForAnimal',
          );
      try {
        var _localCallContext = await _endpointDispatch.getMethodCallContext(
          createSessionCallback: (_) => _localUniqueSession,
          endpointPath: 'carePlan',
          methodName: 'listCarePlansForAnimal',
          parameters: _i1.testObjectToJson({
            'animalIdentificationRecordId': animalIdentificationRecordId,
          }),
          serializationManager: _serializationManager,
        ...
        var _localReturnValue =
            await (_localCallContext.method.call(
                ...
                as _i3.Future<List<_i8.AnimalCarePlan>>);
        return _localReturnValue;
      } finally {
        await _localUniqueSession.close();
      }
  ...
  _i3.Future<bool> archiveCarePlan(
    _i1.TestSessionBuilder sessionBuilder, {
    required int carePlanId,
  }) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      var _localUniqueSession =
          (sessionBuilder as _i1.InternalTestSessionBuilder).internalBuild(
            endpoint: 'carePlan',
            method: 'archiveCarePlan',
          );
      try {
        var _localCallContext = await _endpointDispatch.getMethodCallContext(
          createSessionCallback: (_) => _localUniqueSession,
          endpointPath: 'carePlan',
          methodName: 'archiveCarePlan',
          parameters: _i1.testObjectToJson({'carePlanId': carePlanId}),
          serializationManager: _serializationManager,
        );
        var _localReturnValue =
...
class _MagicLinkEndpoint {
  ...
  _i3.Future<_i9.AuthenticationResponse> verifyMagicLink(
    _i1.TestSessionBuilder sessionBuilder,
    String email,
    String code,
  ) async {
      ...
      try {
        ...
        var _localReturnValue =
            await (_localCallContext.method.call(
                ...
                as _i3.Future<_i9.AuthenticationResponse>);
        return _localReturnValue;
      } finally {
        await _localUniqueSession.close();
      }
